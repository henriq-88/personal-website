type SettingsBrigthnessIconProps = React.SVGProps<SVGSVGElement>

const SettingsBrigthnessIcon: React.FC<SettingsBrigthnessIconProps> = (props) => {
  return (
    <svg
...
export default SettingsBrigthnessIcon;
